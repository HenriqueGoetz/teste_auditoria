...
<body class="relative min-h-[100dvh] bg-[#222221] text-white py-[60px]">
  ...
  <form id="cadastro-empresa" class="mt-[40px] w-full max-w-[480px] mx-auto">
    <h1 class="mx-auto mb-10 text-center text-[24px]">Calcule seu crédito tributário</h1>
    ...
    <div id="loading" class="hidden absolute top-0 bottom-0 left-0 right-0 bg-[rgba(200,200,200,0.5)] items-center justify-center">
